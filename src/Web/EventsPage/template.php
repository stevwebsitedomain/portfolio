...
<head>
  ...
  <title>Events | Digital Matrix Technology</title>
  <meta name="description" content="Upcoming Digital Matrix Technology events in Tanzania — workshops, go-live briefings, cloud clinics, and consultation hours with Steven Makarious.">
  <meta name="author" content="Steven Makarious">
  <meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1">
  <meta name="theme-color" content="#13548c">
  <link rel="canonical" href="https://makarious.legitconsult.co.tz/events">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="Digital Matrix Technology">
  <meta property="og:locale" content="en_TZ">
  <meta property="og:url" content="https://makarious.legitconsult.co.tz/events">
  <meta property="og:title" content="Events | Digital Matrix Technology">
  <meta property="og:description" content="Upcoming workshops, system go-lives, and consultation hours from Digital Matrix Technology in Tanzania.">
  <meta name="twitter:title" content="Events | Digital Matrix Technology">
  <meta name="twitter:description" content="Upcoming workshops, system go-lives, and consultation hours from Digital Matrix Technology in Tanzania.">
    ...
    "@graph": [
      {
        ...
        "itemListElement": [
          ...
          { "@type": "ListItem", "position": 2, "name": "Events", "item": "https://makarious.legitconsult.co.tz/events" }
        ]
      },
      {
        "@type": "CollectionPage",
        "url": "https://makarious.legitconsult.co.tz/events",
        "name": "Events",
...
<body>
  <header class="site-header">
        ...
        <ul class="nav-list" id="navList">
          ...
          <li class="nav-item">
            ...
            <ul class="dropdown">
              ...
              <li><a href="<?= $baseUrl ?>/about#dira" data-i18n="nav_vision">Vision</a></li>
            </ul>
          </li>
          ...
          <li class="nav-item"><a class="nav-link active" href="<?= $baseUrl ?>/events" data-i18n="nav_events">Events</a></li>
    ...
    <main class="page-content events-page">
      <h1 class="sr-only" data-i18n="events_page_title">Events &amp; upcoming sessions</h1>
