...
<head>
  ...
  <title>Contact | Digital Matrix Technology</title>
  <meta name="description" content="Contact Digital Matrix Technology in Tanzania: +255 715 296 092, stevenabalwambo@gmail.com, WhatsApp. Request a website or system quote.">
  <meta name="author" content="Steven Makarious">
  <meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1">
  <meta name="theme-color" content="#13548c">
  <link rel="canonical" href="https://makarious.legitconsult.co.tz/contact">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="Digital Matrix Technology">
  <meta property="og:locale" content="en_TZ">
  <meta property="og:url" content="https://makarious.legitconsult.co.tz/contact">
  <meta property="og:title" content="Contact | Digital Matrix Technology">
  <meta property="og:description" content="Contact Digital Matrix Technology in Tanzania: +255 715 296 092, stevenabalwambo@gmail.com, WhatsApp. Request a website or system quote.">
  <meta name="twitter:title" content="Contact | Digital Matrix Technology">
  <meta name="twitter:description" content="Contact Digital Matrix Technology in Tanzania: +255 715 296 092, stevenabalwambo@gmail.com, WhatsApp. Request a website or system quote.">
    ...
    "@graph": [
  {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "Contact", "item": "https://makarious.legitconsult.co.tz/contact" }
    ]
  },
      {
        "@type": "ContactPage",
        "url": "https://makarious.legitconsult.co.tz/contact",
        "name": "Contact",
        "mainEntity": { "@id": "https://makarious.legitconsult.co.tz/#organization" }
      }
    ]
  }
  </script>
...
<body>
  ...
  <script src="<?= $baseUrl ?>/js/gov-theme.js?v=7"></script>
  <script src="<?= $baseUrl ?>/js/i18n.js?v=11"></script>
</body>
</html>
