...
<head>
  ...
  <title>About | Digital Matrix Technology</title>
  <meta name="description" content="About Digital Matrix Technology in Tanzania — Steven Makarious builds websites, school and office systems, and cloud apps for organizations.">
  <meta name="author" content="Steven Makarious">
  <meta name="robots" content="index, follow, max-image-preview:large, max-snippet:-1">
  <meta name="theme-color" content="#13548c">
  <link rel="canonical" href="https://makarious.legitconsult.co.tz/about">
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="Digital Matrix Technology">
  <meta property="og:locale" content="en_TZ">
  <meta property="og:url" content="https://makarious.legitconsult.co.tz/about">
  <meta property="og:title" content="About | Digital Matrix Technology">
  <meta property="og:description" content="About Digital Matrix Technology in Tanzania — Steven Makarious builds websites, school and office systems, and cloud apps for organizations.">
  <meta name="twitter:title" content="About | Digital Matrix Technology">
  <meta name="twitter:description" content="About Digital Matrix Technology in Tanzania — Steven Makarious builds websites, school and office systems, and cloud apps for organizations.">
    ...
    "@graph": [
  {
    ...
    "itemListElement": [
      ...
      { "@type": "ListItem", "position": 2, "name": "About", "item": "https://makarious.legitconsult.co.tz/about" }
    ]
  },
      {
        "@type": "AboutPage",
        "@id": "https://makarious.legitconsult.co.tz/about#page",
        "url": "https://makarious.legitconsult.co.tz/about",
      ...
      },
      {
        ...
        "url": "https://makarious.legitconsult.co.tz/about",
        "image": "https://makarious.legitconsult.co.tz/images/steven-makarious.jpg",
  ...
  <header class="site-header">
    ...
    <main class="page-content">
      <div class="container moh-split">
        <div class="moh-doc">
          <h2 class="moh-doc-title" data-i18n="about_doc_title">About Digital Matrix Technology</h2>
          <h3 id="historia" data-i18n="about_history">History</h3>
          ...
          <p data-i18n="about_history_p2">Work includes school portals, office and audit systems, e-commerce, travel sites, and agriculture platforms. The approach is practical: a live system that staff and customers can use, with hosting and support after launch.</p>
          <h3 id="dira" data-i18n="about_vision">Vision</h3>
          ...
          <p class="moh-fn" data-i18n="about_fn_1">To design, build, and deploy websites and management systems for schools, offices, and businesses in Tanzania;</p>
        ...
        <?php
        $sidebarTitle = 'Pages';
        $sidebarTitleI18n = 'sidebar_pages';
        $sidebarLinks = [
            ...
            ['href' => $baseUrl . '/news', 'label' => 'News', 'i18n' => 'nav_news'],
