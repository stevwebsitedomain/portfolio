...
class SiteController extends Controller
{
    ...
    public function beforeAction($action): bool
    {
        ...
        $this->layout = in_array($action->id, $appendPages, true) ? 'append' : 'main';
    ...
    public function actionPortfolioDetails(): string
    {
        return $this->render('portfolio-details');
    }

    public function actionServicesDetails(): string
    {
        return $this->render('services-details');
    }

    public function actionStarterPage(): string
    {
        return $this->render('starter-page');
    }
